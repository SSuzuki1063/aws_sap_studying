...
// This file provides build-time data for Astro components.
...
export interface DomainIndexItem {
  domainId: number;
  count: number;
  categories: string[];
}
      ...
      },
      {
        ...
        "resources": [
          ...
          },
          {
            ...
            "href": "continuous-improvement/aws-us-east-1-outage-analysis.html",
            "priority": "low",
            "exam_domains": [
              2,
              3
    ...
    "sections": [
      {
        ...
        "resources": [
          ...
          },
          {
            ...
            "href": "continuous-improvement/beanstalk_blue_green_infographic.html",
            "exam_domains": [
              2,
              3
            ],
    ...
    "sections": [
      {
        ...
        "resources": [
          ...
          },
          {
            ...
            "href": "analytics-bigdata/aws-disk-metrics.html",
            "priority": "low",
            "exam_domains": [
              3
            ],
          ...
          {
            "title": "AWSエラー比較: InstanceLimitExceeded vs Insufficient Instance Capacity",
            "href": "analytics-bigdata/aws-errors-infographic.html",
            "exam_domains": [
              3
            ],
            "difficulty": "beginner",
          ...
          {
            "title": "AWS可用性指標：MTTD・MTTR・MTBF完全ガイド",
            "href": "analytics-bigdata/aws_availability_infographic.html",
            "priority": "high",
            "exam_domains": [
              3
            ],
      ...
      },
      {
        ...
        "resources": [
          ...
          {
            "title": "📊 開発フローチャート",
            "href": "development-flowchart.html",
            "exam_domains": [
              3
            ],
            "difficulty": "intermediate",
...
export const categoryQuickNav: QuickNavItem[] = [
  {
    "id": "networking",
    "icon": "🌐",
    "text": "ネットワーキング",
