...
const examDomains = {
    ...
    domain2: {
        ...
        tasks: [
            ...
            { id: '2.2', title: '事業継続性を確保するソリューションを設計する' },
            { id: '2.3', title: '要件に基づいてセキュリティコントロールを決定する' },
            { id: '2.4', title: '信頼性の要件を満たす戦略を策定する' },
            { id: '2.5', title: 'パフォーマンス目標を満たすソリューションを設計する' },
            { id: '2.6', title: 'ソリューションの目標と目的を達成するためのコスト最適化戦略を決定する' }
        ]
    },
    domain3: {
        id: 'domain3',
